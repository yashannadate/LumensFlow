...
import { User, Banknote, Clock, Zap, Send } from 'lucide-react'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result) {
        ...
        // Removed auto-navigate so the user can see the link and toast
      }
    } catch (err) {
      ...
      <div className="stack" style={{ width: '100%', maxWidth: '480px', gap: '24px' }}>
        ...
        {txHash && (
          <TxSuccess
            ...
            description="Your money stream has been successfully initialized."
            txHash={txHash}
            onDismiss={() => setTxHash(null)}
          />
        )}
          ...
          <div className="card stack" style={{ gap: '20px', padding: '24px' }}>
            <form onSubmit={handleSubmit} className="stack" style={{ gap: '20px' }}>
              ...
              <div className="stack" style={{ gap: '8px' }}>
                ...
                <input
                  required type="number" min="60"
                  className="input" placeholder="e.g. 3600"
                  value={duration}
              ...
              {/* Preview */}
              <div style={{ background: '#0d0d14', border: '1px solid var(--border)', borderRadius: '10px', padding: '16px' }}>
